...
public class TextDrawable extends Drawable {
    ...
    @BindingAdapter(value = {"android:leftText", "android:rightText"}, requireAll = false)
    public static void insertFinalText(EditText editText, String left, String right) {

        TextDrawable leftDrawable = Strings.isNullOrEmpty(left) ? null : new TextDrawable(editText.getContext());
        TextDrawable rightDrawable = Strings.isNullOrEmpty(right) ? null : new TextDrawable(editText.getContext());
        if (leftDrawable != null) {
            leftDrawable.setText(left);
            leftDrawable.setTextColor(editText.getTextColors());
            leftDrawable.setRawTextSize(editText.getTextSize());
            leftDrawable.setTextAlign(Layout.Alignment.ALIGN_NORMAL);
        }

        if (rightDrawable != null) {
            rightDrawable.setText(right);
            rightDrawable.setTextColor(editText.getTextColors());
            rightDrawable.setRawTextSize(editText.getTextSize());
            rightDrawable.setTextAlign(Layout.Alignment.ALIGN_OPPOSITE);
        }
